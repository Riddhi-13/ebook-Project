...
class CatBooks extends Dbh
	{
		...
		public function showBooks(){
			...
			echo '<div style=" background-color: Turquoise;padding: 12px;color: Indigo;"><center><h2 style="font-weight:bold;">Author</h2><p style="font-weight:bold;">~ O ~</p></center></div>';
